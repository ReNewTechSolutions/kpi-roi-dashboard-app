-- =========================================================
-- File: supabase/install.sql
-- KPI + ROI Dashboard App — One-Click Supabase Install
-- Run this single script in Supabase SQL Editor.
--
-- Includes:
-- - Extensions
-- - Core tables: organizations, org_members, kpi_entries, roi_models
-- - Updated_at triggers
-- - RLS enablement + policies + helper functions
-- - Auth trigger to auto-create org + membership + default ROI model + FREE entitlements
-- - Billing tables: billing_customers, billing_subscriptions, entitlements
-- - Billing RLS policies
-- - Helper: ensure_entitlements_for_org(org_id)
-- =========================================================
...
-- =========================================================
-- Billing tables (Stripe scaffold)
-- =========================================================
...
create table if not exists public.entitlements (
  ...
  max_kpi_months_history int not null default 3,
  max_roi_models_per_org int not null default 1,
...
-- =========================================================
-- Helper: ensure entitlements exist
-- =========================================================
...
-- =========================================================
-- Auth trigger: auto-create org + membership + default ROI + entitlements
-- =========================================================
...
begin
  ...
  perform public.ensure_entitlements_for_org(new_org_id);
